...
Page({
    ...
    onSubmit: function(e) {
        ...
        !s.linkman || s.linkman.length <= 1 ? o.toast("请填写联系人姓名") : !s.phone || s.phone.length < 7 ? o.toast("请填写联系手机") : t.SchoolId ? !s.address || s.address.length < 1 ? o.toast("请填写楼名房号") : n.userAddressSave({
            Id: t.Id,
            Linkman: s.linkman,
            Phone: s.phone,
            Gender: t.Gender || 1,
